-- Writing a PL/SQL block using an explicit cursor UpdateLoanInterestRates that will fetche all loans and update their interest rates based on the new policy.
