-- Writing a PL/SQL block that will loop through all customers, check their age, and if they are above 60, will apply a 1% discount to their current loan interest rates.
